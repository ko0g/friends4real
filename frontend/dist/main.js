...
window.onload = () => {
    ...
    toggle_opt_route.onclick = () => {
        if (after_calc || isCalculating || toggle_opt_route.classList[1] === "active")
            return;
        mode_opt_route = true;
    ...
    toggle_opt_point.onclick = () => {
        if (after_calc || isCalculating || toggle_opt_point.classList[1] === "active")
            return;
        mode_opt_point = true;
    ...
    function append_icon(_scale, color, type, e, ind) {
        let svg;
        if (type == 0) {
    ...
    map.on('click', (event) => {
        ...
        if (!clicked_on_map || isCalculating || after_calc)
            return;
        if (points.length === 15) {
    ...
    function get_route(fromPoint, toPoint, curColor, i, order) {
        ...
        fetch('/api/route', {
            ...
            .then(data => {
            var _a;
            if (!((_a = data === null || data === void 0 ? void 0 : data.coords) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    function calc_opt_order(start, points) {
        return fetch('/api/order', {
            ...
            .then(data => {
            var _a;
            if (!((_a = data === null || data === void 0 ? void 0 : data.order) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    function calc_opt_point(points) {
        return fetch('/api/point', {
            ...
            .then(res => res.json())
            .then(data => {
            if ((data === null || data === void 0 ? void 0 : data.point) === null) {
    ...
    calcbtn.onclick = () => {
        ...
        if (!map_was_changed || points.length === 0 || isCalculating)
            return;
        map_was_changed = false;
        routeSource.clear();
        isCalculating = true;
