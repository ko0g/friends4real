...
Протестировать: http://5.129.241.119:3000 (активно до ноября 2025).

## Установка и запуск

*!!! Также понадобится поставить собственный OSRM сервер с картой города и пешими маршрутами (в идеале на MLD для самых оптимальных тропинок).*
